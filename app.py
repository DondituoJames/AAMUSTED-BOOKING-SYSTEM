...
def completeAppointment():
    if request.method == "GET":
        ...
        if len(o_validate) !=0:
            db.add_others((name, phone, oid, dob, marriage, work_type, emp_sector, problem_category, counsellor_choice,counsellor, gender))
...
def completeStudent():
    if request.method == "GET":
        ...
        if len(temp) < 3:
            ...
            message = f'This is to notify you that you have booked counselling session on {curr} with {Choosecounsellor} Please come to the counselling centre at {venue[7]}.Counselling centre is open from 8 am to 9pm. Thank You'
            ...
            try:
                sendMail("AAMUSTED Counselling Centre",message, Semail)
...
def completeLeturer():
    ...
    message = f'This is to notify you that you have booked counselling session at {curr} with {ChooseCounsellor} Please come to the counselling centre at {venue[7]}.Counselling centre is open from 8 am to 9pm. Thank You'
